#Script requires PowerShell 3.0
...
$postresponse = Invoke-WebRequest -Uri https://www2.rsna.org/timssnet/login/caslogin.cfm -Method POST -Body $fields
...
If($failure)
{
Send-MailMessage -To $SmtpTo -Subject "$website POST Issue" -SmtpServer $SmtpServer -From NoReply@rsna.org -Body "Post to $website failed to respond with a 200 status code."
}
Else
{
Exit
